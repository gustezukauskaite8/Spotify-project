...
if era_choices:
    ...
    if not final_df.empty:
        ...
        # --- Compact Line Chart for better fit ---
        fig_line = px.line(
            yearly_counts,
            x="release_year",
            y="Total Releases",
        ...
        fig_line.update_traces(
            ...
            line_width=3,
            marker=dict(size=6, color=BRAND_COLORS['text'], symbol='circle')
        )
        ...
        fig_line.update_layout(
            ...
            yaxis=dict(
                title="Songs",
                showgrid=True,
                gridcolor='rgba(34, 12, 16, 0.1)',
                color=BRAND_COLORS['text']
            ),
            font=dict(color=BRAND_COLORS['text'], size=10)
        )

        st.plotly_chart(theme_plotly(fig_line), width="stretch")
